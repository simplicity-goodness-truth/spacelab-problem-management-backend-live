*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_YSLPMSTATEMAILVW
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_YSLPMSTATEMAILVW    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_YSLPMSTATEMAILVW'
         EXPORTING
              FCODE          = READ
...
EXTRACT = YSLPMSTATEMAILVW_EXTRACT
TOTAL = YSLPMSTATEMAILVW_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_YSLPMSTATEMAILVW'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_YSLPMSTATEMAILVW-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = YSLPMSTATEMAILVW_EXTRACT
TOTAL = YSLPMSTATEMAILVW_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_YSLPMSTATEMAILVW-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_YSLPMSTATEMAILVW'
...
TOTAL = YSLPMSTATEMAILVW_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_YSLPMSTATEMAILVW-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_YSLPMSTATEMAILVW-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_YSLPMSTATEMAILVW'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_YSLPMSTATEMAILVW-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = YSLPMSTATEMAILVW_EXTRACT
TOTAL = YSLPMSTATEMAILVW_TOTAL
