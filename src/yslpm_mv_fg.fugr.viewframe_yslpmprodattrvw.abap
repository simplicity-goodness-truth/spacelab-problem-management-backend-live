*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_YSLPMPRODATTRVW
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_YSLPMPRODATTRVW     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_YSLPMPRODATTRVW'
         EXPORTING
              FCODE          = READ
...
EXTRACT = YSLPMPRODATTRVW_EXTRACT
TOTAL = YSLPMPRODATTRVW_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_YSLPMPRODATTRVW'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_YSLPMPRODATTRVW-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = YSLPMPRODATTRVW_EXTRACT
TOTAL = YSLPMPRODATTRVW_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_YSLPMPRODATTRVW-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_YSLPMPRODATTRVW'
...
TOTAL = YSLPMPRODATTRVW_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_YSLPMPRODATTRVW-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_YSLPMPRODATTRVW-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_YSLPMPRODATTRVW'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_YSLPMPRODATTRVW-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = YSLPMPRODATTRVW_EXTRACT
TOTAL = YSLPMPRODATTRVW_TOTAL
