*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_YCRMOAUTOSTATVW
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_YCRMOAUTOSTATVW     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_YCRMOAUTOSTATVW'
         EXPORTING
              FCODE          = READ
...
EXTRACT = YCRMOAUTOSTATVW_EXTRACT
TOTAL = YCRMOAUTOSTATVW_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_YCRMOAUTOSTATVW'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_YCRMOAUTOSTATVW-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = YCRMOAUTOSTATVW_EXTRACT
TOTAL = YCRMOAUTOSTATVW_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_YCRMOAUTOSTATVW-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_YCRMOAUTOSTATVW'
...
TOTAL = YCRMOAUTOSTATVW_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_YCRMOAUTOSTATVW-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_YCRMOAUTOSTATVW-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_YCRMOAUTOSTATVW'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_YCRMOAUTOSTATVW-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = YCRMOAUTOSTATVW_EXTRACT
TOTAL = YCRMOAUTOSTATVW_TOTAL
