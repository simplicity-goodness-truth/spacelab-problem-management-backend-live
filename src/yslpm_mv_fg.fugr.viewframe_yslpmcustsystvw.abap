*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_YSLPMCUSTSYSTVW
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_YSLPMCUSTSYSTVW     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_YSLPMCUSTSYSTVW'
         EXPORTING
              FCODE          = READ
...
EXTRACT = YSLPMCUSTSYSTVW_EXTRACT
TOTAL = YSLPMCUSTSYSTVW_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_YSLPMCUSTSYSTVW'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_YSLPMCUSTSYSTVW-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = YSLPMCUSTSYSTVW_EXTRACT
TOTAL = YSLPMCUSTSYSTVW_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_YSLPMCUSTSYSTVW-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_YSLPMCUSTSYSTVW'
...
TOTAL = YSLPMCUSTSYSTVW_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_YSLPMCUSTSYSTVW-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_YSLPMCUSTSYSTVW-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_YSLPMCUSTSYSTVW'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_YSLPMCUSTSYSTVW-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = YSLPMCUSTSYSTVW_EXTRACT
TOTAL = YSLPMCUSTSYSTVW_TOTAL
