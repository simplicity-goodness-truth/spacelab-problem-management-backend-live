*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_YSLPMHTTPHDRVW
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_YSLPMHTTPHDRVW      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_YSLPMHTTPHDRVW'
         EXPORTING
              FCODE          = READ
...
EXTRACT = YSLPMHTTPHDRVW_EXTRACT
TOTAL = YSLPMHTTPHDRVW_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_YSLPMHTTPHDRVW'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_YSLPMHTTPHDRVW-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = YSLPMHTTPHDRVW_EXTRACT
TOTAL = YSLPMHTTPHDRVW_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_YSLPMHTTPHDRVW-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_YSLPMHTTPHDRVW'
...
TOTAL = YSLPMHTTPHDRVW_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_YSLPMHTTPHDRVW-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_YSLPMHTTPHDRVW-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_YSLPMHTTPHDRVW'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_YSLPMHTTPHDRVW-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = YSLPMHTTPHDRVW_EXTRACT
TOTAL = YSLPMHTTPHDRVW_TOTAL
