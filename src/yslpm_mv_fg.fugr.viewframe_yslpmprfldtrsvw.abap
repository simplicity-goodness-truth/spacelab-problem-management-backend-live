*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_YSLPMPRFLDTRSVW
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_YSLPMPRFLDTRSVW     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_YSLPMPRFLDTRSVW'
         EXPORTING
              FCODE          = READ
...
EXTRACT = YSLPMPRFLDTRSVW_EXTRACT
TOTAL = YSLPMPRFLDTRSVW_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_YSLPMPRFLDTRSVW'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_YSLPMPRFLDTRSVW-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = YSLPMPRFLDTRSVW_EXTRACT
TOTAL = YSLPMPRFLDTRSVW_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_YSLPMPRFLDTRSVW-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_YSLPMPRFLDTRSVW'
...
TOTAL = YSLPMPRFLDTRSVW_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_YSLPMPRFLDTRSVW-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_YSLPMPRFLDTRSVW-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_YSLPMPRFLDTRSVW'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_YSLPMPRFLDTRSVW-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = YSLPMPRFLDTRSVW_EXTRACT
TOTAL = YSLPMPRFLDTRSVW_TOTAL
