...
FORM GET_DATA_YCRMOAUTOSTATVW.
  PERFORM VIM_FILL_WHERETAB.
*.read data from database.............................................*
  REFRESH TOTAL.
  CLEAR   TOTAL.
  SELECT * FROM YCRMO_AUTO_STAT WHERE
(VIM_WHERETAB) .
    CLEAR YCRMOAUTOSTATVW .
YCRMOAUTOSTATVW-MANDT =
YCRMO_AUTO_STAT-MANDT .
YCRMOAUTOSTATVW-PROCESSTYPE =
YCRMO_AUTO_STAT-PROCESSTYPE .
YCRMOAUTOSTATVW-STATUSIN =
YCRMO_AUTO_STAT-STATUSIN .
YCRMOAUTOSTATVW-STATUSOUT =
YCRMO_AUTO_STAT-STATUSOUT .
YCRMOAUTOSTATVW-STAYONSTATUSINHOURS =
YCRMO_AUTO_STAT-STAYONSTATUSINHOURS .
YCRMOAUTOSTATVW-STTEXT =
YCRMO_AUTO_STAT-STTEXT .
YCRMOAUTOSTATVW-TEXTTYPE =
YCRMO_AUTO_STAT-TEXTTYPE .
<VIM_TOTAL_STRUC> = YCRMOAUTOSTATVW.
    APPEND TOTAL.
  ENDSELECT.
...
ENDFORM.
*---------------------------------------------------------------------*
FORM DB_UPD_YCRMOAUTOSTATVW .
*.process data base updates/inserts/deletes.........................*
LOOP AT TOTAL.
  CHECK <ACTION> NE ORIGINAL.
MOVE <VIM_TOTAL_STRUC> TO YCRMOAUTOSTATVW.
  IF <ACTION> = UPDATE_GELOESCHT.
    <ACTION> = GELOESCHT.
  ENDIF.
  CASE <ACTION>.
   WHEN NEUER_GELOESCHT.
IF STATUS_YCRMOAUTOSTATVW-ST_DELETE EQ GELOESCHT.
    ...
    ENDIF.
   WHEN GELOESCHT.
  SELECT SINGLE FOR UPDATE * FROM YCRMO_AUTO_STAT WHERE
  PROCESSTYPE = YCRMOAUTOSTATVW-PROCESSTYPE AND
  STATUSIN = YCRMOAUTOSTATVW-STATUSIN .
    IF SY-SUBRC = 0.
    DELETE YCRMO_AUTO_STAT .
    ENDIF.
...
YCRMOAUTOSTATVW-TEXTTYPE .
    IF SY-SUBRC = 0.
    UPDATE YCRMO_AUTO_STAT ##WARN_OK.
    ELSE.
    INSERT YCRMO_AUTO_STAT .
    ENDIF.
    READ TABLE EXTRACT WITH KEY <VIM_XTOTAL_KEY>.
    IF SY-SUBRC EQ 0.
      <XACT> = ORIGINAL.
  ...
  ENDCASE.
ENDLOOP.
CLEAR: STATUS_YCRMOAUTOSTATVW-UPD_FLAG,
STATUS_YCRMOAUTOSTATVW-UPD_CHECKD.
MESSAGE S018(SV).
ENDFORM.
*---------------------------------------------------------------------*
FORM READ_SINGLE_YCRMOAUTOSTATVW.
  SELECT SINGLE * FROM YCRMO_AUTO_STAT WHERE
PROCESSTYPE = YCRMOAUTOSTATVW-PROCESSTYPE AND
STATUSIN = YCRMOAUTOSTATVW-STATUSIN .
YCRMOAUTOSTATVW-MANDT =
YCRMO_AUTO_STAT-MANDT .
...
ENDFORM.
*---------------------------------------------------------------------*
FORM CORR_MAINT_YCRMOAUTOSTATVW USING VALUE(CM_ACTION) RC.
  DATA: RETCODE LIKE SY-SUBRC, COUNT TYPE I, TRSP_KEYLEN TYPE SYFLENG.
  FIELD-SYMBOLS: <TAB_KEY_X> TYPE X.
  CLEAR RC.
MOVE YCRMOAUTOSTATVW-PROCESSTYPE TO
YCRMO_AUTO_STAT-PROCESSTYPE .
MOVE YCRMOAUTOSTATVW-STATUSIN TO
YCRMO_AUTO_STAT-STATUSIN .
MOVE YCRMOAUTOSTATVW-MANDT TO
YCRMO_AUTO_STAT-MANDT .
  CORR_KEYTAB             =  E071K.
  CORR_KEYTAB-OBJNAME     = 'YCRMO_AUTO_STAT'.
  IF NOT <vim_corr_keyx> IS ASSIGNED.
    ASSIGN CORR_KEYTAB-TABKEY TO <vim_corr_keyx> CASTING.
  ENDIF.
  ASSIGN YCRMO_AUTO_STAT TO <TAB_KEY_X> CASTING.
  PERFORM VIM_GET_TRSPKEYLEN
    USING 'YCRMO_AUTO_STAT'
