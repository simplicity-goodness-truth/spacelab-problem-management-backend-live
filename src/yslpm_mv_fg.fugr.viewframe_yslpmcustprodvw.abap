*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_YSLPMCUSTPRODVW
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_YSLPMCUSTPRODVW     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_YSLPMCUSTPRODVW'
         EXPORTING
              FCODE          = READ
...
EXTRACT = YSLPMCUSTPRODVW_EXTRACT
TOTAL = YSLPMCUSTPRODVW_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_YSLPMCUSTPRODVW'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_YSLPMCUSTPRODVW-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = YSLPMCUSTPRODVW_EXTRACT
TOTAL = YSLPMCUSTPRODVW_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_YSLPMCUSTPRODVW-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_YSLPMCUSTPRODVW'
...
TOTAL = YSLPMCUSTPRODVW_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_YSLPMCUSTPRODVW-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_YSLPMCUSTPRODVW-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_YSLPMCUSTPRODVW'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_YSLPMCUSTPRODVW-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = YSLPMCUSTPRODVW_EXTRACT
TOTAL = YSLPMCUSTPRODVW_TOTAL
