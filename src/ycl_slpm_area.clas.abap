class YCL_SLPM_AREA definition
  public
...
public section.
  ...
  constants AREA_NAME type SHM_AREA_NAME value 'YCL_SLPM_AREA' ##NO_TEXT.
  data ROOT type ref to YCL_SLPM_SHMA read-only .
  ...
  class-methods ATTACH_FOR_READ
    ...
    returning
      value(HANDLE) type ref to YCL_SLPM_AREA
    raising
      CX_SHM_INCONSISTENT
  ...
  methods SET_ROOT
    importing
      !ROOT type ref to YCL_SLPM_SHMA
    raising
...
CLASS YCL_SLPM_AREA IMPLEMENTATION.
