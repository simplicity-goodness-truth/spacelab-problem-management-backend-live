...
"    lo_slpm_user = new ycl_slpm_user( sy-uname ).
  ...
  method get_all_stco_from_storage.
    ...
    rt_status_codes = new ycl_slpm_status_codes_storage( )->yif_slpm_status_codes_storage~get_status_codes_record( ip_status_codes_record_id )->get_all_status_codes( ).
